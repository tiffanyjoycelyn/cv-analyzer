...
ActiveRecord::Schema[8.0].define(version: 2025_10_07_183912) do
  ...
  create_table "job_details", force: :cascade do |t|
    ...
    t.string "role"
    t.index ["file_id"], name: "index_job_details_on_file_id"
  ...
  add_foreign_key "job_details", "jobs"
  add_foreign_key "job_details", "uploaded_files", column: "file_id"
